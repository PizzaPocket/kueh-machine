# Spec: Timeline Song Counts

## Purpose

Defines the number of songs displayed per year card in the timeline — 3 popular songs and 1 forgotten gem — and the rule that a song cannot occupy both slots.

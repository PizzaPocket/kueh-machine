...
func _contributors() -> Array[Dictionary]:
	...
	var contributors: Array[Dictionary] = [
		...
		_person("Amy Fu", Vector3(-7.0, 0, -13), Vector3(-5.2, 0, -11.3), "amy_gacha", "/amy/", "Give the knob a turn. Every capsule has a little Kueh surprise inside.", _appearance(0.90, 1.13, HubPalette.TAN_SKIN, HubPalette.BLACK_HAIR, "medium_long", Color("1e314d"), Color("355677"), true)),
		...
		_person("Li Wei Lim", Vector3(14, 0, -1.8), Vector3(11.7, 0, 0), "lapis_arcade", "/liwei/", "The snake keeps growing, just like the layers of a good lapis. See how long you can last.", _appearance(1.04, 1.13, HubPalette.TAN_SKIN, HubPalette.BLACK_HAIR, "long", Color("315b43"), Color("355677"))),
		_person("Mei Jun Chew", Vector3(-14, 0, 9), Vector3(-11.7, 0, 9), "meijun", "/meijun/", "Taste has a way of taking you home. This is where I keep those memories.", _appearance(0.98, 1.13, HubPalette.TAN_SKIN, Color("3f2a20"), "long", HubPalette.WHITE, Color("355677"), true, true).merged({"upper_arm_thickness": 1.15})),
		...
		_person("Samantha Tan", Vector3(14, 0, 9), Vector3(11.7, 0, 9), "remember", "/samantha/", "Pick an era and follow the devices that carried its songs. Some memories start with a play button.", _appearance(1.04, 1.13, HubPalette.TAN_SKIN, Color("443b37"), "very_long", HubPalette.WHITE, Color("d9c6a5"))),
		...
		_person("Viki Yap", Vector3(-14, 0, 15), Vector3(-11.7, 0, 15), "viki", "/viki/", "Build a kueh nobody's auntie has made yet.", _appearance(0.90, 1.13, HubPalette.TAN_SKIN, HubPalette.DARK_BROWN_HAIR, "long", Color("f2ede2"), Color("f2ede2"), false, false, true)),
	]
